<div class="m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-content">
        <div class="m-portlet m-portlet--tab">
            ...
            <!--begin::Form-->
            <form id="category_form" class="m-form m-form--fit m-form--label-align-right" method="POST" action="/web_act/category_add">
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-10">
                            <input class="form-control m-input" type="text" name="category_name" id="category_name">
                        </div>
                    </div>
                </div>
