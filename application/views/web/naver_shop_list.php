                                        ...
                                        <div class="m-dropdown__body">
                                            <div class="m-dropdown__content">
                                                <ul class="m-nav">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="/web/naver_shop_config" class="m-nav__link">
...
<!--                                                    <li class="m-nav__item">-->
<!--                                                        <a href="/web_act/naver_all_waring_off" class="m-nav__link">-->
                ...
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="/web/naver_shop_add" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                    <span>
...
<script src="/application/views/web/js/web/naver_shop_list.js" type="text/javascript"></script>
